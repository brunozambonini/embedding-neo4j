...
export const CONFIG = Object.freeze({
    ...
    // Given a document, split it into chunks of this size (in characters), with this much overlap between chunks
    textSplitter: {
        chunkSize: 1000,
        chunkOverlap: 200,
    },
    // Given chunks of text, convert them into vectors using this embedding model
    embedding: {
